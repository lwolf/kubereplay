...
import (
	...
	. "github.com/lwolf/kubereplay/pkg/client/clientset/versioned/typed/kubereplay/v1alpha1"
)

// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the Refinery resource tests

var _ = Describe("Refinery", func() {
	var instance Refinery
	var expected Refinery
