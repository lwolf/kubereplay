...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1alpha1_ControlledObject_To_kubereplay_ControlledObject,
		Convert_kubereplay_ControlledObject_To_v1alpha1_ControlledObject,
...
func autoConvert_v1alpha1_ControlledObject_To_kubereplay_ControlledObject(in *ControlledObject, out *kubereplay.ControlledObject, s conversion.Scope) error {
	out.Kind = in.Kind
	out.BlueName = in.BlueName
	out.BlueReplicas = in.BlueReplicas
	out.GreenName = in.GreenName
	out.GreenReplicas = in.GreenReplicas
	return nil
}

// Convert_v1alpha1_ControlledObject_To_kubereplay_ControlledObject is an autogenerated conversion function.
func Convert_v1alpha1_ControlledObject_To_kubereplay_ControlledObject(in *ControlledObject, out *kubereplay.ControlledObject, s conversion.Scope) error {
	return autoConvert_v1alpha1_ControlledObject_To_kubereplay_ControlledObject(in, out, s)
}

func autoConvert_kubereplay_ControlledObject_To_v1alpha1_ControlledObject(in *kubereplay.ControlledObject, out *ControlledObject, s conversion.Scope) error {
	out.Kind = in.Kind
	out.BlueName = in.BlueName
	out.BlueReplicas = in.BlueReplicas
	out.GreenName = in.GreenName
...
// Convert_kubereplay_ControlledObject_To_v1alpha1_ControlledObject is an autogenerated conversion function.
func Convert_kubereplay_ControlledObject_To_v1alpha1_ControlledObject(in *kubereplay.ControlledObject, out *ControlledObject, s conversion.Scope) error {
	return autoConvert_kubereplay_ControlledObject_To_v1alpha1_ControlledObject(in, out, s)
}
...
func autoConvert_v1alpha1_HarvesterStatus_To_kubereplay_HarvesterStatus(in *HarvesterStatus, out *kubereplay.HarvesterStatus, s conversion.Scope) error {
	out.ControlledObjects = *(*[]kubereplay.ControlledObject)(unsafe.Pointer(&in.ControlledObjects))
	return nil
}
...
func autoConvert_kubereplay_HarvesterStatus_To_v1alpha1_HarvesterStatus(in *kubereplay.HarvesterStatus, out *HarvesterStatus, s conversion.Scope) error {
	out.ControlledObjects = *(*[]ControlledObject)(unsafe.Pointer(&in.ControlledObjects))
	return nil
}
