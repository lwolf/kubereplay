...
type HarvesterInterface interface {
	Create(*replay.Harvester) (*replay.Harvester, error)
	Update(*replay.Harvester) (*replay.Harvester, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*replay.Harvester, error)
	List(opts v1.ListOptions) (*replay.HarvesterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *replay.Harvester, err error)
	HarvesterExpansion
}
...
func newHarvesters(c *KubereplayClient, namespace string) *harvesters {
	return &harvesters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *harvesters) Get(name string, options v1.GetOptions) (result *replay.Harvester, err error) {
	result = &replay.Harvester{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("harvesters").
		Name(name).
...
func (c *harvesters) List(opts v1.ListOptions) (result *replay.HarvesterList, err error) {
	result = &replay.HarvesterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("harvesters").
...
func (c *harvesters) Create(harvester *replay.Harvester) (result *replay.Harvester, err error) {
	result = &replay.Harvester{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("harvesters").
...
func (c *harvesters) Update(harvester *replay.Harvester) (result *replay.Harvester, err error) {
	result = &replay.Harvester{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("harvesters").
...
func (c *harvesters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *replay.Harvester, err error) {
	result = &replay.Harvester{}
