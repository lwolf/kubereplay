...
import (
	...
	scheme "github.com/lwolf/kube-replay/pkg/client/clientset/internalversion/scheme"
...
type RefineryInterface interface {
	Create(*replay.Refinery) (*replay.Refinery, error)
	Update(*replay.Refinery) (*replay.Refinery, error)
	UpdateStatus(*replay.Refinery) (*replay.Refinery, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*replay.Refinery, error)
	List(opts v1.ListOptions) (*replay.RefineryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *replay.Refinery, err error)
	RefineryExpansion
}
...
func newRefineries(c *KubereplayClient, namespace string) *refineries {
	return &refineries{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *refineries) Get(name string, options v1.GetOptions) (result *replay.Refinery, err error) {
	result = &replay.Refinery{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("refineries").
		Name(name).
...
func (c *refineries) List(opts v1.ListOptions) (result *replay.RefineryList, err error) {
	result = &replay.RefineryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("refineries").
...
func (c *refineries) Create(refinery *replay.Refinery) (result *replay.Refinery, err error) {
	result = &replay.Refinery{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("refineries").
...
func (c *refineries) Update(refinery *replay.Refinery) (result *replay.Refinery, err error) {
	result = &replay.Refinery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("refineries").
...
func (c *refineries) UpdateStatus(refinery *replay.Refinery) (result *replay.Refinery, err error) {
	result = &replay.Refinery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("refineries").
...
func (c *refineries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *replay.Refinery, err error) {
	result = &replay.Refinery{}
