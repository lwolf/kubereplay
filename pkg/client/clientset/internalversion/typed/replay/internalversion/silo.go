...
type SiloInterface interface {
	Create(*replay.Silo) (*replay.Silo, error)
	Update(*replay.Silo) (*replay.Silo, error)
	UpdateStatus(*replay.Silo) (*replay.Silo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*replay.Silo, error)
	List(opts v1.ListOptions) (*replay.SiloList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *replay.Silo, err error)
	SiloExpansion
}
...
func newSilos(c *KubereplayClient, namespace string) *silos {
	return &silos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *silos) Get(name string, options v1.GetOptions) (result *replay.Silo, err error) {
	result = &replay.Silo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("silos").
...
func (c *silos) List(opts v1.ListOptions) (result *replay.SiloList, err error) {
	result = &replay.SiloList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("silos").
...
func (c *silos) Create(silo *replay.Silo) (result *replay.Silo, err error) {
	result = &replay.Silo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("silos").
...
func (c *silos) Update(silo *replay.Silo) (result *replay.Silo, err error) {
	result = &replay.Silo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("silos").
...
func (c *silos) UpdateStatus(silo *replay.Silo) (result *replay.Silo, err error) {
	result = &replay.Silo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("silos").
...
func (c *silos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *replay.Silo, err error) {
	result = &replay.Silo{}
